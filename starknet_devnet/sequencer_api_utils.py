"""
Copied from https://github.com/starkware-libs/cairo-lang/blob/v0.11.0-pre/src/starkware/starknet/services/utils/sequencer_api_utils.py
"""
...
class InternalAccountTransactionForSimulate(InternalAccountTransaction):
    ...
    def create_for_simulate(
        cls,
        external_tx: EverestTransaction,
        ...
        return dataclasses.replace(
            internal_tx_without_flags, skip_validate=skip_validate
        )
...
@dataclasses.dataclass(frozen=True)
class InternalDeclareForSimulate(
